...
<section class="card border border-base-300 bg-base-100 p-5 sm:p-6">
  ...
  {:else if !workers.length}<div class="mt-6 rounded-xl border border-dashed border-base-300 p-10 text-center text-sm text-base-content/50">No workers have reported yet.</div>
