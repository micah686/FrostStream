...
<section class={card}>
  ...
  <details class="card collapse mb-5 border border-base-300 bg-base-100 p-4">
    ...
    <div class="collapse-content px-0 pb-0">
      <div class="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div class="md:col-span-2"><label class="label mb-1 text-xs" for="headers">Extra HTTP headers (one FIELD:VALUE per line)</label><textarea id="headers" bind:value={headers} rows="3" class="w-full rounded-lg border border-base-300 bg-base-100 p-2.5 text-sm text-base-content"></textarea></div>
