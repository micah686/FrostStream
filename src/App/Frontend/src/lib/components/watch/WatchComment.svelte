    ...
    <div class="min-w-0 flex-1">
      ...
      <p class="flex flex-wrap items-center gap-2 text-xs">
        {#if comment.isUploader}
          <span class="inline-flex items-center gap-1.5 rounded-full border border-primary/40 bg-primary/20 px-3 py-1 font-semibold text-primary shadow-sm shadow-blue-950/30">
