...
public sealed class M022_AddCreatorSourceFullScanCursor : Migration
{
    ...
    {
        Execute.Sql("ALTER TABLE discovery.creator_sources DROP CONSTRAINT IF EXISTS ck_creator_sources_next_full_scan_start_index_positive;");
        Delete.Column("next_full_scan_start_index").FromTable("creator_sources").InSchema("discovery");
    }
}
