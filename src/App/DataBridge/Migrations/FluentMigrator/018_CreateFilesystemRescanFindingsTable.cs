...
public sealed class M018_CreateFilesystemRescanFindingsTable : Migration
{
    ...
    public override void Up()
    {
        ...
        Create.Table("filesystem_rescan_findings").InSchema(SchemaName)
        ...
        Create.Index("uq_filesystem_rescan_findings_key_path_type")
            .OnTable("filesystem_rescan_findings").InSchema(SchemaName)
    ...
    {
        Delete.Table("filesystem_rescan_findings").InSchema(SchemaName);
