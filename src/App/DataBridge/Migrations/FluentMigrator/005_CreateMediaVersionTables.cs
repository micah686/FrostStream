...
public sealed class M005_CreateMediaVersionTables : Migration
{
    ...
    {
        Delete.Index("ux_media_content_id_versions_storage_key_content_hash").OnTable("media_content_id_versions");
        Delete.Index("ux_media_content_id_versions_media_guid_version_num").OnTable("media_content_id_versions");
        ...
        Delete.Index("ix_media_source_versions_media_guid").OnTable("media_source_versions");
        Delete.Index("ix_media_source_versions_provider_source_media_id").OnTable("media_source_versions");
